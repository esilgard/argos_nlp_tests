...
import re
from dev.fhcrc_pathology.lung import PathStageT
from dev.fhcrc_pathology.lung import global_strings as dict_keys

EXPECTED_STAGE_NAME='PathStageT'
EXPECTED_REGEX='.*(pT[012345][abc]?).*'
...
class PathStageTHappyCase(unittest.TestCase):
    ...
    def test_get_happy_case(self, mock_match):
        ...
        #self.assertEqual(self.path_stage_t.
